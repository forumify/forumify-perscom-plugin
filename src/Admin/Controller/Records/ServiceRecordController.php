...
{
    protected ?string $permissionView = 'perscom-io.admin.records.service_records.view';
    protected ?string $permissionCreate = 'perscom-io.admin.records.service_records.create';
    protected ?string $permissionDelete = 'perscom-io.admin.records.service_records.delete';
    ...
    {
        return 'PerscomAdminServiceRecordTable';
    }
}
